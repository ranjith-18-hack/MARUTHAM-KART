...
export const TransportSidebar = () => {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 h-screen bg-white border-r border-[#DCE8DF] sticky top-0 overflow-hidden">
      ...
      <div className="p-4 border-t border-[#DCE8DF] space-y-2">
        <Link 
          to="/portal-select"
          className="flex items-center space-x-3 px-4 py-2 rounded-xl text-slate-600 hover:bg-slate-50 transition-all font-bold text-xs"
        >
